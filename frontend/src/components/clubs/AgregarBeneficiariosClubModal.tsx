...
interface AgregarBeneficiariosClubModalProps {
  isOpen: boolean;
  onClose: () => void;
...
export default function AgregarBeneficiariosClubModal({
  isOpen,
  onClose,
  onAgregar,
  beneficiariosActuales
}: AgregarBeneficiariosClubModalProps) {
  ...
  return (
    <Modal
      isOpen={isOpen}
      onClose={onClose}
      title="Agregar Beneficiarios al Club"
      size="lg"
    >
            ...
            <div className="text-center py-12">
              ...
              <p className="text-sm text-gray-500 px-8">
                {beneficiariosActuales.length > 0
                  ? 'Todos los beneficiarios disponibles ya están inscritos en este club.'
                  : 'No se encontraron beneficiarios activos.'}
              </p>
            </div>
          ) : (
