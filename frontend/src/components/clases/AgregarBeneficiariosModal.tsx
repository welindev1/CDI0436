...
interface AgregarBeneficiariosModalProps {
  isOpen: boolean;
  onClose: () => void;
...
export default function AgregarBeneficiariosModal({
  isOpen,
  onClose,
  onAgregar,
  beneficiariosActuales
}: AgregarBeneficiariosModalProps) {
            ...
            <div className="text-center py-12">
              ...
              <p className="text-sm text-gray-500 px-8">
                {beneficiariosActuales.length > 0
                  ? 'Todos los beneficiarios disponibles ya están inscritos en esta clase, o no existen beneficiarios sin clase/curso asignado.'
