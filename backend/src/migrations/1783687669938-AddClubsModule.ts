...
export class AddClubsModule1783687669938 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."horarios_dia_enum" AS ENUM('lunes', 'martes', 'miercoles', 'jueves', 'viernes', 'sabado', 'domingo')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."asistencias_estado_enum" AS ENUM('presente', 'ausente')`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_ASISTENCIAS_REGISTRADO_POR" ON "asistencias" ("registradoPorId") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_ASISTENCIAS_BENEFICIARIO_ID" ON "asistencias" ("beneficiarioId") `);
        await queryRunner.query(`CREATE INDEX "IDX_ASISTENCIAS_CLASE_ID" ON "asistencias" ("claseId") `);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_ASISTENCIAS_UNICA" ON "asistencias" ("claseId", "beneficiarioId", "fecha") `);
        await queryRunner.query(`CREATE TABLE "supervivencias" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "nombre" character varying(100) NOT NULL, "descripcion" text, "codigo" character varying(50), "capacidad_maxima" integer NOT NULL DEFAULT '0', "activo" boolean NOT NULL DEFAULT true, "creado_en" TIMESTAMP NOT NULL DEFAULT now(), "actualizado_en" TIMESTAMP NOT NULL DEFAULT now(), "tutor_id" uuid, CONSTRAINT "PK_51907775e4947bbea94d0f53fc3" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "asistencias_club" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "fecha" date NOT NULL, "presente" boolean NOT NULL DEFAULT false, "observaciones" text, "creado_en" TIMESTAMP NOT NULL DEFAULT now(), "actualizado_en" TIMESTAMP NOT NULL DEFAULT now(), "club_id" uuid NOT NULL, "beneficiario_id" uuid NOT NULL, CONSTRAINT "PK_e33348cae231c2fb0c5d916c95e" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_ASIS_CLUB_COMPOSITE" ON "asistencias_club" ("club_id", "fecha") `);
        await queryRunner.query(`CREATE INDEX "IDX_ASIS_CLUB_FECHA" ON "asistencias_club" ("fecha") `);
        await queryRunner.query(`CREATE INDEX "IDX_ASIS_CLUB_BENEFICIARIO_ID" ON "asistencias_club" ("beneficiario_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_ASIS_CLUB_CLUB_ID" ON "asistencias_club" ("club_id") `);
        await queryRunner.query(`CREATE TABLE "clubes" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "nombre" character varying(100) NOT NULL, "descripcion" text, "codigo" character varying(50), "capacidad_maxima" integer NOT NULL DEFAULT '0', "activo" boolean NOT NULL DEFAULT true, "creado_en" TIMESTAMP NOT NULL DEFAULT now(), "actualizado_en" TIMESTAMP NOT NULL DEFAULT now(), "tutor_id" uuid, CONSTRAINT "PK_fb4807a2b8fe43f7bd7b80cf146" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_CLUBES_ACTIVO" ON "clubes" ("activo") `);
        await queryRunner.query(`CREATE INDEX "IDX_CLUBES_CODIGO" ON "clubes" ("codigo") `);
        await queryRunner.query(`CREATE INDEX "IDX_CLUBES_TUTOR_ID" ON "clubes" ("tutor_id") `);
        await queryRunner.query(`CREATE TABLE "beneficiario_expedientes" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "tipo" character varying(50) NOT NULL DEFAULT 'libre', "titulo" character varying(255), "mostrar_titulo" boolean NOT NULL DEFAULT true, "contenido" text, "fecha_evento" date, "imagen_base64" text, "imagenes_galeria" jsonb, "pdfs" jsonb, "etiqueta_color" character varying(20), "creado_en" TIMESTAMP NOT NULL DEFAULT now(), "beneficiario_id" uuid, CONSTRAINT "PK_c54b4f56bee0c2c4920630d9069" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "fotos_asistencia" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "fecha" date NOT NULL, "imagen_url" text NOT NULL, "nombre_original" character varying(255), "creado_en" TIMESTAMP NOT NULL DEFAULT now(), "actualizado_en" TIMESTAMP NOT NULL DEFAULT now(), "claseId" uuid, CONSTRAINT "PK_9299e3a4952052bd87a19742f62" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_FOTOS_ASIST_FECHA" ON "fotos_asistencia" ("fecha") `);
        await queryRunner.query(`CREATE INDEX "IDX_FOTOS_ASIST_CLASE_ID" ON "fotos_asistencia" ("claseId") `);
        await queryRunner.query(`CREATE INDEX "IDX_FOTOS_ASIST_CLASE_FECHA" ON "fotos_asistencia" ("claseId", "fecha") `);
        await queryRunner.query(`CREATE TYPE "public"."reportes_tipo_enum" AS ENUM('asistencia_clase', 'asistencia_alumno', 'asistencia_periodo', 'asistencia_global')`);
        await queryRunner.query(`CREATE TYPE "public"."reportes_formato_enum" AS ENUM('pdf', 'excel', 'csv')`);
        await queryRunner.query(`CREATE TABLE "reportes" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "tipo" "public"."reportes_tipo_enum" NOT NULL, "formato" "public"."reportes_formato_enum" NOT NULL, "filtros" json NOT NULL, "ruta_archivo" text, "fecha_inicio" date, "fecha_fin" date, "creado_en" TIMESTAMP NOT NULL DEFAULT now(), "generadoPorId" uuid, CONSTRAINT "PK_4204634633cb4099bc06b27a17e" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_REPORTES_GENERADO_POR_ID" ON "reportes" ("generadoPorId") `);
        ...
        await queryRunner.query(`CREATE TABLE "comentarios_ayuda" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "contenido" text NOT NULL, "autor" character varying(100) NOT NULL, "creado_en" TIMESTAMP NOT NULL DEFAULT now(), "ayuda_id" uuid, CONSTRAINT "PK_faa7ff37c01bd798dcc1f508e68" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "supervivencia_beneficiario" ("supervivencia_id" uuid NOT NULL, "beneficiario_id" uuid NOT NULL, CONSTRAINT "PK_978ad53c0280d5504b692fd9180" PRIMARY KEY ("supervivencia_id", "beneficiario_id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_89a9fc433cf0bd43455231b7ca" ON "supervivencia_beneficiario" ("supervivencia_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_3d36559529efa9897b3a38cb49" ON "supervivencia_beneficiario" ("beneficiario_id") `);
        await queryRunner.query(`CREATE TABLE "club_beneficiario" ("club_id" uuid NOT NULL, "beneficiario_id" uuid NOT NULL, CONSTRAINT "PK_1592b0a495ee3f4bbea4d11e85c" PRIMARY KEY ("club_id", "beneficiario_id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_e95e8db3deac56aa8cc6a25b41" ON "club_beneficiario" ("club_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_538ff4c620f8cc04aed88f744b" ON "club_beneficiario" ("beneficiario_id") `);
        await queryRunner.query(`CREATE TABLE "clase_horario" ("clase_id" uuid NOT NULL, "horario_id" uuid NOT NULL, CONSTRAINT "PK_8635bd9dfe1902bda3783a28695" PRIMARY KEY ("clase_id", "horario_id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_3c20c677b0c3879bba978a51d8" ON "clase_horario" ("clase_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_2562a357f93f0c00ba0b2a3c19" ON "clase_horario" ("horario_id") `);
        await queryRunner.query(`CREATE TABLE "clase_beneficiario" ("clase_id" uuid NOT NULL, "beneficiario_id" uuid NOT NULL, CONSTRAINT "PK_e4df5be85dd078fe3f0cf0b4fa2" PRIMARY KEY ("clase_id", "beneficiario_id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_7f7656be038afbc52540bc40fb" ON "clase_beneficiario" ("clase_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_d3c88878bfab8b7b6aacafaa56" ON "clase_beneficiario" ("beneficiario_id") `);
        ...
        await queryRunner.query(`ALTER TABLE "asistencias" ADD CONSTRAINT "FK_89fa299e063f84e7915033d24ff" FOREIGN KEY ("claseId") REFERENCES "clases"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "asistencias" ADD CONSTRAINT "FK_f79354c7ff1bb313e4309d662a7" FOREIGN KEY ("beneficiarioId") REFERENCES "beneficiarios"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "asistencias" ADD CONSTRAINT "FK_d528b8072832ed1c486afd5a53c" FOREIGN KEY ("registradoPorId") REFERENCES "usuarios"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "supervivencias" ADD CONSTRAINT "FK_28de2d97ddcde9d046144edb488" FOREIGN KEY ("tutor_id") REFERENCES "tutores"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "asistencias_club" ADD CONSTRAINT "FK_d033d2d8b66ae38094f7dacad9e" FOREIGN KEY ("club_id") REFERENCES "clubes"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "asistencias_club" ADD CONSTRAINT "FK_87b7df5778b1fa1f1d014197854" FOREIGN KEY ("beneficiario_id") REFERENCES "beneficiarios"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "clubes" ADD CONSTRAINT "FK_de83ab9b83db4631481c08ddaa1" FOREIGN KEY ("tutor_id") REFERENCES "tutores"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "beneficiario_expedientes" ADD CONSTRAINT "FK_aa7bdf389808038a4baebac0c02" FOREIGN KEY ("beneficiario_id") REFERENCES "beneficiarios"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "clases" ADD CONSTRAINT "FK_d198464173f1e2c0c4f6ab02045" FOREIGN KEY ("tutorId") REFERENCES "tutores"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "tutores" ADD CONSTRAINT "FK_2cd1b40dea7dcf73fbd737c1fb6" FOREIGN KEY ("usuarioId") REFERENCES "usuarios"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "fotos_asistencia" ADD CONSTRAINT "FK_9c006101f9cf75b713bd7b7ff01" FOREIGN KEY ("claseId") REFERENCES "clases"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "reportes" ADD CONSTRAINT "FK_a8cb294a9e1c05cb5214eddfcb3" FOREIGN KEY ("generadoPorId") REFERENCES "usuarios"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "asistencias_supervivencia" ADD CONSTRAINT "FK_3d6c638c82bfc8f7e8a9a3f4958" FOREIGN KEY ("supervivencia_id") REFERENCES "supervivencias"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "asistencias_supervivencia" ADD CONSTRAINT "FK_155dfad83fdab997da701fee411" FOREIGN KEY ("beneficiario_id") REFERENCES "beneficiarios"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "fotos_asistencia_supervivencia" ADD CONSTRAINT "FK_d8aedc4aa2dfe2c9fe2bfb7f2cf" FOREIGN KEY ("supervivencia_id") REFERENCES "supervivencias"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "fotos_asistencia_club" ADD CONSTRAINT "FK_d39b6d0960afcf6f01c7eaaa8a7" FOREIGN KEY ("club_id") REFERENCES "clubes"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "notas_merito" ADD CONSTRAINT "FK_c0eba8ae0dce03fe43d57abaf40" FOREIGN KEY ("periodo_id") REFERENCES "periodos_merito"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "notas_merito" ADD CONSTRAINT "FK_5598848995573555a8592eaf7c0" FOREIGN KEY ("beneficiario_id") REFERENCES "beneficiarios"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "comentarios_ayuda" ADD CONSTRAINT "FK_61d74bf0423c3468957fed8b79e" FOREIGN KEY ("ayuda_id") REFERENCES "ayudas"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "supervivencia_beneficiario" ADD CONSTRAINT "FK_89a9fc433cf0bd43455231b7ca8" FOREIGN KEY ("supervivencia_id") REFERENCES "supervivencias"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "supervivencia_beneficiario" ADD CONSTRAINT "FK_3d36559529efa9897b3a38cb495" FOREIGN KEY ("beneficiario_id") REFERENCES "beneficiarios"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "club_beneficiario" ADD CONSTRAINT "FK_e95e8db3deac56aa8cc6a25b41a" FOREIGN KEY ("club_id") REFERENCES "clubes"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "club_beneficiario" ADD CONSTRAINT "FK_538ff4c620f8cc04aed88f744b9" FOREIGN KEY ("beneficiario_id") REFERENCES "beneficiarios"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "clase_horario" ADD CONSTRAINT "FK_3c20c677b0c3879bba978a51d81" FOREIGN KEY ("clase_id") REFERENCES "clases"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "clase_horario" ADD CONSTRAINT "FK_2562a357f93f0c00ba0b2a3c195" FOREIGN KEY ("horario_id") REFERENCES "horarios"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "clase_beneficiario" ADD CONSTRAINT "FK_7f7656be038afbc52540bc40fb6" FOREIGN KEY ("clase_id") REFERENCES "clases"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "clase_beneficiario" ADD CONSTRAINT "FK_d3c88878bfab8b7b6aacafaa562" FOREIGN KEY ("beneficiario_id") REFERENCES "beneficiarios"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "clase_beneficiario" DROP CONSTRAINT "FK_d3c88878bfab8b7b6aacafaa562"`);
        await queryRunner.query(`ALTER TABLE "clase_beneficiario" DROP CONSTRAINT "FK_7f7656be038afbc52540bc40fb6"`);
        await queryRunner.query(`ALTER TABLE "clase_horario" DROP CONSTRAINT "FK_2562a357f93f0c00ba0b2a3c195"`);
        await queryRunner.query(`ALTER TABLE "clase_horario" DROP CONSTRAINT "FK_3c20c677b0c3879bba978a51d81"`);
        await queryRunner.query(`ALTER TABLE "club_beneficiario" DROP CONSTRAINT "FK_538ff4c620f8cc04aed88f744b9"`);
        await queryRunner.query(`ALTER TABLE "club_beneficiario" DROP CONSTRAINT "FK_e95e8db3deac56aa8cc6a25b41a"`);
        await queryRunner.query(`ALTER TABLE "supervivencia_beneficiario" DROP CONSTRAINT "FK_3d36559529efa9897b3a38cb495"`);
        await queryRunner.query(`ALTER TABLE "supervivencia_beneficiario" DROP CONSTRAINT "FK_89a9fc433cf0bd43455231b7ca8"`);
        ...
        await queryRunner.query(`ALTER TABLE "comentarios_ayuda" DROP CONSTRAINT "FK_61d74bf0423c3468957fed8b79e"`);
        await queryRunner.query(`ALTER TABLE "notas_merito" DROP CONSTRAINT "FK_5598848995573555a8592eaf7c0"`);
        await queryRunner.query(`ALTER TABLE "notas_merito" DROP CONSTRAINT "FK_c0eba8ae0dce03fe43d57abaf40"`);
        await queryRunner.query(`ALTER TABLE "fotos_asistencia_club" DROP CONSTRAINT "FK_d39b6d0960afcf6f01c7eaaa8a7"`);
        await queryRunner.query(`ALTER TABLE "fotos_asistencia_supervivencia" DROP CONSTRAINT "FK_d8aedc4aa2dfe2c9fe2bfb7f2cf"`);
        await queryRunner.query(`ALTER TABLE "asistencias_supervivencia" DROP CONSTRAINT "FK_155dfad83fdab997da701fee411"`);
        await queryRunner.query(`ALTER TABLE "asistencias_supervivencia" DROP CONSTRAINT "FK_3d6c638c82bfc8f7e8a9a3f4958"`);
        await queryRunner.query(`ALTER TABLE "reportes" DROP CONSTRAINT "FK_a8cb294a9e1c05cb5214eddfcb3"`);
        await queryRunner.query(`ALTER TABLE "fotos_asistencia" DROP CONSTRAINT "FK_9c006101f9cf75b713bd7b7ff01"`);
        await queryRunner.query(`ALTER TABLE "tutores" DROP CONSTRAINT "FK_2cd1b40dea7dcf73fbd737c1fb6"`);
        await queryRunner.query(`ALTER TABLE "clases" DROP CONSTRAINT "FK_d198464173f1e2c0c4f6ab02045"`);
        await queryRunner.query(`ALTER TABLE "beneficiario_expedientes" DROP CONSTRAINT "FK_aa7bdf389808038a4baebac0c02"`);
        await queryRunner.query(`ALTER TABLE "clubes" DROP CONSTRAINT "FK_de83ab9b83db4631481c08ddaa1"`);
        await queryRunner.query(`ALTER TABLE "asistencias_club" DROP CONSTRAINT "FK_87b7df5778b1fa1f1d014197854"`);
        await queryRunner.query(`ALTER TABLE "asistencias_club" DROP CONSTRAINT "FK_d033d2d8b66ae38094f7dacad9e"`);
        await queryRunner.query(`ALTER TABLE "supervivencias" DROP CONSTRAINT "FK_28de2d97ddcde9d046144edb488"`);
        await queryRunner.query(`ALTER TABLE "asistencias" DROP CONSTRAINT "FK_d528b8072832ed1c486afd5a53c"`);
        await queryRunner.query(`ALTER TABLE "asistencias" DROP CONSTRAINT "FK_f79354c7ff1bb313e4309d662a7"`);
        await queryRunner.query(`ALTER TABLE "asistencias" DROP CONSTRAINT "FK_89fa299e063f84e7915033d24ff"`);
        await queryRunner.query(`ALTER TABLE "usuarios" DROP CONSTRAINT "FK_9e519760a660751f4fa21453d3e"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_d3c88878bfab8b7b6aacafaa56"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_7f7656be038afbc52540bc40fb"`);
        await queryRunner.query(`DROP TABLE "clase_beneficiario"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_2562a357f93f0c00ba0b2a3c19"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_3c20c677b0c3879bba978a51d8"`);
        await queryRunner.query(`DROP TABLE "clase_horario"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_538ff4c620f8cc04aed88f744b"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_e95e8db3deac56aa8cc6a25b41"`);
        await queryRunner.query(`DROP TABLE "club_beneficiario"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_3d36559529efa9897b3a38cb49"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_89a9fc433cf0bd43455231b7ca"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_NOTAS_MERITO_PERIODO_ID"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_NOTAS_MERITO_BENEFICIARIO_ID"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_92e65934d4455abc9f50cb1089"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_FOTOS_SUPERV_SUPERVIVENCIA_ID"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_ASIS_SUPERV_SUPERVIVENCIA_ID"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_ASIS_SUPERV_BENEFICIARIO_ID"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_REPORTES_GENERADO_POR_ID"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_FOTOS_ASIST_CLASE_FECHA"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_EXPEDIENTES_BENEFICIARIO_ID"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_EXPEDIENTES_TIPO"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_EXPEDIENTES_FECHA_EVENTO"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_ASIS_CLUB_BENEFICIARIO_ID"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_SUPERVIVENCIAS_TUTOR_ID"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_ASISTENCIAS_BENEFICIARIO_ID"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_ASISTENCIAS_REGISTRADO_POR"`);
